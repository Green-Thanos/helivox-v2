          ...
          <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>
                  Tips and strategies for students to successfully apply to
                  their dream schools.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>
                  Insights on the challenges faced by underserved students and
                  how Helivox is making a difference.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <img
